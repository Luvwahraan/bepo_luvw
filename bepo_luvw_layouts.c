 ...
 * `--------+------+------+------+------+-------------,-------------.      ,-------------`-------------+------+------+------+------+--------'
 *   | Left |  Up  |   %  | PgUp | LDesk|             | C+alt|Super |      | Super| C+alt|             | RDesk|PgDown|   W  | Down | Right|
 *   `----------------------------------'      ,------|------|------|      |------+------+------.      `----------------------------------'
 *                                             |  FN  |      |lctrl |      |rctrl |      |  FN  |
...
_______,     BP_AGRV,     BP_Y,        BP_X,        BP_DOT,      BP_K,        KC_BSPC,
TD_COPY,     TD_PASTE,    BP_PERC,     KC_PGUP,     LWS,
                          ...
                          KC_BSPC,     BP_APOS,     BP_Q,        BP_G,        BP_H,        BP_F,        _______,
